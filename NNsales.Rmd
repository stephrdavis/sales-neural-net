...
# Introduction
This is an application of a neural network designed to identify characterists of car buyers.  This purose is to direct advertising
...
nTrain = 0
nTest=0
nTrain = round(0.70*lengthData,0)
...
```{r}
linearModel = lm(sales~(.-salesTgt)^2, data = trainDataSet)
summary(linearModel)
```
...
print(paste('actual = ',trainDataSet$salesTgt[randomTest],'  predicted: ',ifelse(predictSales[1:9]>0.5,1,0 )))
...
```{r}
predictTest = predict(salesNet, testDataSet)
